...
| Path | Purpose |
|------|---------|
| [basic](basic/) | Simple apply — `vm.pico` NL |
...
Registry: [`hostkey-cloud-ru/hostkey-ru`](https://registry.terraform.io/providers/hostkey-cloud-ru/hostkey-ru/latest). COM: [`hostkey-cloud/hostkey-com`](https://registry.terraform.io/providers/hostkey-cloud/hostkey-com/latest).
