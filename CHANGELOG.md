...
terraform state replace-provider \
  ...
  'registry.terraform.io/hostkey-cloud/hostkey-ru'
```
...
- Registry docs (`docs/`) and README are Russian / [hostkey.ru](https://hostkey.ru). [`README.en.md`](README.en.md) points at the COM repo.
