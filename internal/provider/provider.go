...
func (p *hostkeyProvider) Schema(_ context.Context, _ provider.SchemaRequest, resp *provider.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Interact with Hostkey (RU) infrastructure via InvAPI (invapi.hostkey.ru).",
		Attributes: map[string]schema.Attribute{
			...
			"base_url": schema.StringAttribute{
				Description: "InvAPI base URL override (default https://invapi.hostkey.ru/). HTTPS required except localhost. Staging hosts must be on hostkey.ru. May be set via HOSTKEY_BASE_URL or HOSTKEY_API_URL. Use hostkey-cloud/hostkey-com for invapi.hostkey.com.",
				Optional:    true,
