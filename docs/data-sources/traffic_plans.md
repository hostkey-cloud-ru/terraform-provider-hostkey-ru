...
Lists traffic plans ([`traffic_plans/list`](https://hostkey.ru/documentation/apidocs/traffic_plans/#traffic_planslist)). InvAPI often requires `location`. The provider requests this list **without** a customer session token (sending a token frequently breaks the call).
...
InvAPI: [`traffic_plans/list`](https://hostkey.ru/documentation/apidocs/traffic_plans/#traffic_planslist).
